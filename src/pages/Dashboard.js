    ...
    <div className="container">
      ...
      <div className="bg-amber-50 h-full flex flex-col items-center w-screen">
          {userCollectionsArray.map((userCollection) => {
            return (
              <div className="flex border-2 border-amber-900 rounded w-2/5 m-4 py-1 items-center">
                <div key={userCollection.id} className="flex flex-col">
                  <div className="flex flex-col mx-auto border-4 border-double border-amber-900 w-3/4 text-center">             
