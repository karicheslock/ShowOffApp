    ...
    <div>
        <div className='flex mb-4'>
            <button onClick={() => handleClick('upvote')} disabled={checkIfCollectionIsAlreadyVoted()} className="mr-2">
                { isVoting ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='fill-emerald-600 w-6'>
            ...
            <p className='px-2 mr-2 border-2 rounded border-black'>{userCollection.upVotesCount}</p>
        </div>
        <div className='flex'>
            <button onClick={() => handleClick('downvote')} disabled={checkIfCollectionIsAlreadyVoted()} className="mr-2">
                { isVoting ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='fill-rose-400 w-6'>
            ...
            <p className='px-2 mr-2 border-2 rounded border-black'>{userCollection.downVotesCount}</p>
        </div>
    </div>
  )
}
