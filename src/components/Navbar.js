...
function Navbar({setIsAuth}) {
  ...
  return (
    <div className="flex items-center w-screen h-24 bg-amber-100 justify-between px-10">
      ...
      {isAuth && <Link to='/create-collection' className='border-2 rounded border-amber-400 px-4 py-2 bg-amber-400 text-amber-50 font-bold hover:bg-amber-900'>+ Add Collection</Link>}
